export const aiWorkflowPilotFixture = {
  entry_id: 'SESSION-DEMO-AI-PILOT-001', title: 'AI-enabled capture workflow pilot', achievement_date: '2026-06-30',
  summary: 'Led a six-month AI-enabled capture workflow pilot involving business development, solution engineering, operations, and proposal stakeholders. The pilot moved from workflow discovery through controlled testing and produced an approved transition plan for broader operational use.',
  action_taken: 'Defined the workflow, coordinated stakeholders, established testing criteria, evaluated outputs, documented limitations, and prepared the transition recommendation.',
  outcome: 'Produced an approved transition plan and a repeatable operating model for broader adoption.',
